...
source("ssGSEAProjection/common.R")
source("ssGSEAProjection/ssGSEAProjection.Library.R")
source("ssGSEAProjection/ssGSEAProjection.R")
ssGSEA.project.dataset(javaexec="", jardir="", input.ds="counts_per-symbol-max.gct", output.ds=projected, gene.sets.dbfile.list="fernando_genesets_noMIR.gmt", gene.sets.database="")
