...
vsd = read.delim('/Users/olgabotvinnik/workspace/rna-seq-diff-exprn/test-results/expression/htseq/figures/DESeq/htseq_all_groups_cutoff-0_vsd.txt', row.names=1)
...
pdf('/Users/olgabotvinnik/workspace/rna-seq-diff-exprn/test-results/expression/htseq/figures/DESeq/htseq_all_groups_cutoff-0_LNCaP_group-PrEC_group_sampleClustering.pdf')
