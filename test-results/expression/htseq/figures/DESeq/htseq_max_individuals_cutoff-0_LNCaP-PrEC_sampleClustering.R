...
vsd = read.delim('/Users/olgabotvinnik/workspace/rna-seq-diff-exprn/test-results/expression/htseq/figures/DESeq/htseq_max_individuals_cutoff-0_vsd.txt', row.names=1)
...
pdf('/Users/olgabotvinnik/workspace/rna-seq-diff-exprn/test-results/expression/htseq/figures/DESeq/htseq_max_individuals_cutoff-0_LNCaP-PrEC_sampleClustering.pdf')
