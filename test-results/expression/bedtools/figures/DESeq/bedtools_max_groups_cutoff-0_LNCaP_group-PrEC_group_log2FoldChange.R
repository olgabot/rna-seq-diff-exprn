...
res = read.delim('/Users/olgabotvinnik/workspace/rna-seq-diff-exprn/test-results/expression/bedtools/figures/DESeq/bedtools_max_groups_cutoff-0_LNCaP_group-PrEC_group_DEseq.txt')
...
pdf('/Users/olgabotvinnik/workspace/rna-seq-diff-exprn/test-results/expression/bedtools/figures/DESeq/bedtools_max_groups_cutoff-0_LNCaP_group-PrEC_group_log2FoldChange.pdf')
