#/usr/bin/Rscript
# /Users/olgabotvinnik/workspace/rna-seq-diff-exprn/test-results/expression/bedtools/figures/DESeq/bedtools_all_individuals_cutoff-0_varianceStabilizedData.R
...
load('/Users/olgabotvinnik/workspace/rna-seq-diff-exprn/test-results/expression/bedtools/figures/DESeq/bedtools_all_individuals_cutoff-0_varianceStabilizedData_mean-vs-sd.Robject')
load('/Users/olgabotvinnik/workspace/rna-seq-diff-exprn/test-results/expression/bedtools/figures/DESeq/bedtools_all_individuals_cutoff-0_dispersionEstimates.Robject')
filename.base = '/Users/olgabotvinnik/workspace/rna-seq-diff-exprn/test-results/expression/bedtools/figures/DESeq/bedtools_all_individuals_cutoff-0'
